/**
 * API Route: Delete Mutual Fund Holding
 * 
 * DELETE /api/mf/delete/[id]
 * 
 * Deletes a mutual fund holding for the authenticated user
 */
...
export async function DELETE(
  ...
  try {
    ...
    if (deleteError) {
      console.error('[MF Delete API] Error deleting holding:', deleteError);
      return NextResponse.json(
    ...
    console.error('[MF Delete API] Error:', error);
    return NextResponse.json(
