      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6 sm:py-8 pt-20 sm:pt-24">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            ...
            title="Add EPF Account"
          >
            <PlusIcon className="w-5 h-5 shrink-0" />
            <span className="hidden md:inline">Add EPF Account</span>
          </button>
        </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="min-w-0 flex-1">
                      <div className="font-semibold text-[#0F172A] dark:text-[#F8FAFC]">{holding.employerName}</div>
                      <div className="text-xs text-[#6B7280] dark:text-[#94A3B8] font-mono">{maskUAN(holding.uan)}</div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <span className="text-[#6B7280] dark:text-[#94A3B8]">Contributions</span>
                    ...
                    <div>
                      ...
                      <div className="font-medium text-[#0F172A] dark:text-[#F8FAFC]">{formatDate(holding.lastUpdated)}</div>
                    </div>
                  </div>
