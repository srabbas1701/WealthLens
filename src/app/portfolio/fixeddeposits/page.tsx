  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        showToast({
          type: 'success',
          title: modalMode === 'add' ? 'Fixed Deposit Added' : 'Fixed Deposit Updated',
          message: modalMode === 'add' 
            ? 'Your fixed deposit has been added successfully.' 
        ...
        showToast({
          ...
          message: result.error || 'Unable to save fixed deposit. Please try again.',
          duration: 7000,
        });
      }
    } catch (error) {
      ...
      showToast({
        ...
        message: 'Failed to save fixed deposit. Please check your connection and try again.',
        duration: 7000,
      });
    } finally {
      setSubmitting(false);
    ...
    try {
      ...
      if (result.success) {
        ...
        showToast({
          ...
          message: 'The fixed deposit has been removed from your portfolio.',
          duration: 5000,
        });
      } else {
        showToast({
          ...
          message: result.error || 'Unable to delete fixed deposit. Please try again.',
          duration: 7000,
        });
      }
    } catch (error) {
      ...
      showToast({
        type: 'error',
        title: 'Error Occurred',
        message: 'Failed to delete fixed deposit. Please check your connection and try again.',
        duration: 7000,
      });
    } finally {
      setDeleting(false);
