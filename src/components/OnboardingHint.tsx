...
export default function OnboardingHint({
  ...
  return (
    <div className={`relative ${className}`} ref={hintRef}>
      ...
      >
        <div className="bg-white rounded-lg border border-[#E5E7EB] shadow-lg p-4">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 mt-0.5">
              <InfoIcon className="w-5 h-5 text-[#2563EB]" />
            </div>
            ...
            <button
              ...
              className="flex-shrink-0 p-1 rounded-lg hover:bg-[#F6F8FB] transition-colors"
          ...
          {/* Arrow */}
          <div
            className={`absolute w-2 h-2 bg-white border-r border-b border-[#E5E7EB] transform rotate-45 ${
